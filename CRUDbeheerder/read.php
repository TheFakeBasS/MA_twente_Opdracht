    ...
    if($stmt = $pdo->prepare($sql)){
        ...
        if($stmt->execute()){
            if($stmt->rowCount() == 1){
                ...
                $naam = $row["naam"];
                $straat = $row["vraag"];
                $huisnummer = $row["antwoord"];
                $huisnummer = $row["categorie"];
            } else{
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label>Vraag</label>
                        <p><b><?php echo $row["vraag"]; ?></b></p>
                    </div>
                    <div class="form-group">
                        <label>Antwoord</label>
                        <p><b><?php echo $row["antwoord"]; ?></b></p>
                    </div>
                    <div class="form-group">
                        <label>Categorie</label>
                        <p><b><?php echo $row["categorie"]; ?></b></p>
                    </div>
                    <p><a href="faqCRUD.php" class="btn btn-primary">Terug</a></p>
                </div>
            </div>        
        </div>
    </div>
